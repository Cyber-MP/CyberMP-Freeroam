...
import { Route as HudMenuInfoRouteImport } from './routes/hud.menu/info'
...
const HudMenuInfoRoute = HudMenuInfoRouteImport.update({
  id: '/info',
  path: '/info',
  getParentRoute: () => HudMenuRouteRoute,
} as any)
...
export interface FileRoutesByFullPath {
  ...
  '/hud/menu/info': typeof HudMenuInfoRoute
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/hud/menu/info': {
      id: '/hud/menu/info'
      path: '/info'
      fullPath: '/hud/menu/info'
      preLoaderRoute: typeof HudMenuInfoRouteImport
      parentRoute: typeof HudMenuRouteRoute
    }
    '/hud/menu/matchmaking/': {
...
interface HudMenuRouteRouteChildren {
  HudMenuInfoRoute: typeof HudMenuInfoRoute
...
const HudMenuRouteRouteChildren: HudMenuRouteRouteChildren = {
  HudMenuInfoRoute: HudMenuInfoRoute,
